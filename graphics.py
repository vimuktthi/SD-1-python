...
class GraphWin(tk.Canvas):
    ...
    def close(self) -> object:
        ...
        # Additional code to run after the window is closed
        # For example, you can print a message

        # Call any other functions or methods you want to run after window closure
        # ...

        self.__autoflush()  # Assuming you want to call this method as well
